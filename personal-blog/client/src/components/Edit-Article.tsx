...
export default function EditArticle({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <textarea className="border-gray-400 border-2 border-solid p-3 rounded-sm h-100 text-left align-top w-full" placeholder="Content" />
      <button className="w-[30%] cursor-pointer hover:bg-gray-100 text-black p-3 border-2 border-gray-400 border-solid rounded-md">Click</button>
    </div>
  );
}
